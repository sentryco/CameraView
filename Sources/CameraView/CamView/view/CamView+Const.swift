 ...
 * - Note: This extension defines constants for the supported QR code types, the onComplete closure alias, and the default onComplete callback. In a real world application, you could add support for customizing these constants to better suit your needs.
 */
#if os(iOS)
import AVFoundation
...
extension CamView {
    ...
    * - Description: This constant array holds the types of QR codes that the CamView class can process. It includes a variety of common QR code types such as UPC-E, Code 39, Code 93, Code 128, EAN-8, EAN-13, Aztec, PDF417, and QR code type.
    ...
    * - Description: This closure is invoked when a QR code is successfully captured by the CamView. The payload parameter contains the data encoded in the QR code.
    * - Parameters:
    ...
    * - Note: This callback simply prints a message to the console. In a real world application, you could replace this with a more meaningful callback.
    */
